    ...
    public void onLoginButtonClick(ActionEvent actionEvent) throws IOException {
        ...
        else
        {
            ...
            if(service.loginAngajat(angajat.getUsername(), angajat.getPassword()) != null){
                ...
                loader.setLocation(getClass().getResource("/MainPageAngajat.fxml"));
                AnchorPane root = loader.load();
                MainPageAngajatController controller = loader.getController();
                controller.setService(this.service);
                controller.initialize();
                Scene scene = new Scene(root, 1007, 506);
